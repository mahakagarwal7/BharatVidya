...
class DomainTheme:
    ...
    CHEMISTRY = {
        ...
        "border_style": "orbital",        
        "particle_style": "molecular",    
        "carbon": (80, 80, 80),
    ...
    CS = {
        ...
        "border_style": "pixel",          
        "particle_style": "binary",       
        "box_fill": (20, 50, 60),         
        "box_active": (40, 80, 100),     
        "box_highlight": (80, 200, 150),  
    }
...
def create_linear_equation_clip(duration: float = 5.0,
    ...
    def make_frame(t):
        ...
        if t > duration * 0.7:
            ...
            p2 = world_to_screen(x2, y1)  
            p3 = world_to_screen(x2, y2)
            
            draw.line([p1, p2], fill=theme["secondary"], width=2)
            draw.line([p2, p3], fill=theme["accent"], width=2)
...
def create_chemistry_clip(duration: float = 5.0,
    ...
    def make_frame(t):
        ...
        for i in range(4):
            ...
            color = theme["secondary"] if i % 2 == 0 else theme["nitrogen"]
...
def create_statistics_clip(duration: float = 5.0,
    ...
    data = [max(10, min(90, d)) for d in data]
...
def create_gas_law_clip(duration: float = 5.0,
    ...
    def make_frame(t):
        ...
        compression = 0.5 + 0.3 * math.sin(t * 1.5)
...
def create_magnetic_field_clip(duration: float = 5.0,
    ...
    def make_frame(t):
        ...
        for i in range(num_lines):
            angle_offset = (i - num_lines // 2) * 15 + 90
            ...
            for j in range(20):
                ...
                arc_height = 80 + abs(angle_offset - 90) * 2
